...
describe("LocalStorageService", () => {
  ...
  it("sets and gets private entries", () => {
    service.setProtected("AUTH_USER_DISPLAY_NAME", "private_user_name");
    expect(service.getProtected("AUTH_USER_DISPLAY_NAME")).toEqual("private_user_name");
    expect(localStorage.getItem("rp-contact-field._auth_user_display_name")).toEqual(
      "private_user_name"
    );
  });
