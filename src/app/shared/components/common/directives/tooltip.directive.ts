...
export class TooltipDirective implements AfterViewInit, OnDestroy {
    ...
    this.zone.runOutsideAngular(() => {
      switch (this.tooltipEvent) {
        ...
        case "focus":
          ...
          break;
        case "click":
          this.clickListener = this.onMouseClickTarget.bind(this);
          this.el.nativeElement.addEventListener("click", this.clickListener);
          break;
      }
    });
  ...
  show() {
    ...
    if (this.tooltipZIndex === "auto") this.container.style.zIndex = ++DomHandler.zindex;
  ...
  alignTop() {
    ...
    let left =
      hostOffset.left +
      (DomHandler.getOuterWidth(this.el.nativeElement) - DomHandler.getOuterWidth(this.container)) /
        2;
  ...
  onClickOutside(e: Event) {
    return !this.el.nativeElement.contains(e.target) ? this.hide() : null;
  }
  ...
  remove() {
    if (this.container && this.container.parentElement) {
      ...
      else DomHandler.removeChild(this.container, this.appendTo);
    }
