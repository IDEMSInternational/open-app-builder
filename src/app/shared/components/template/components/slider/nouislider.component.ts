...
/**
 * Copy of https://github.com/tb/ng2-nouislider to remove dependency on deprecated package
 */
@Component({
  selector: "nouislider",
  host: {
...
export class NouisliderComponent implements ControlValueAccessor, OnChanges, OnDestroy {
  public slider: any;
  public handles: any[] = [];
  ...
  private defaultKeyHandler = (e: KeyboardEvent) => {
    ...
    let index = parseInt((e.target as HTMLElement).getAttribute("data-handle") as string);
    let sign = 1;
