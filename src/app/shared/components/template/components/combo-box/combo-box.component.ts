...
export class TmplComboBoxComponent extends TemplateBaseComponent implements ITemplateRowProps, OnInit {
  ...
  ngOnInit(): void {
    ...
    this.customAnswerSelected = listAnswers && this._row.value ? !listAnswers.split(";").find(x => x === this._row.value) : false;
