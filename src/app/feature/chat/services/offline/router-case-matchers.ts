...
export function matchesCase(routerCase: RapidProFlowExport.RouterCase, operand: string) {
  switch (routerCase.type) {
    case "has_only_phrase":
      return routerCase.arguments[0].toLowerCase() === operand.toLowerCase();
    case "has_any_word":
      return matchHasAnyWordCase(routerCase, operand);
    case "has_number_between":
      return matchHasNumberBetweenCase(routerCase, operand);
    case "has_number_gt":
      return matchHasNumberGreaterThanCase(routerCase, operand);
    case "has_number_lt":
      return matchHasNumberLessThanCase(routerCase, operand);
    default:
      return false;
  }
}

export function matchHasNumberGreaterThanCase(
  routerCase: RapidProFlowExport.RouterCase,
  operand: string
): boolean {
...
export function matchHasNumberLessThanCase(
  routerCase: RapidProFlowExport.RouterCase,
  operand: string
): boolean {
...
export function matchHasNumberBetweenCase(
  routerCase: RapidProFlowExport.RouterCase,
  operand: string
): boolean {
  let rangeNumbers = routerCase.arguments
...
export function matchHasAnyWordCase(
  routerCase: RapidProFlowExport.RouterCase,
  operand: string
): boolean {
  let matchStrings = [];
