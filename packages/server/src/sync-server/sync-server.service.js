...
function SyncServer(socketPort) {
  let db = {
    ...
    subscribe: function (fn) { // research
      db.subscribers.push(fn);
    },
    unsubscribe: function (fn) { // research
  ...
  ws.createServer(function (conn) {
      ...
      async function sendAnyChanges() {
        ...
        let reducedArray = Object.keys(reducedSet).map(function (key) { return reducedSet[key]; });
