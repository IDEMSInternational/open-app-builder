...
class SheetsPostProcessor {
  ...
  public run() {
    ...
    this.hackGenerateAssetContentsDataList(app_data.output_path, appSheetsFolder);
  ...
  private hackGenerateAssetContentsDataList(appDataFolder: string, appSheetsFolder: string) {
    ...
    const flow_name = "required_assets";
