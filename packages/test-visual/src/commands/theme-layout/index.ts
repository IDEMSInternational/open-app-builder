...
const ENCAPSULATED_COMPONENT_STYLES = {
  ...
  gsi: `${COMPONENTS_FOLDER}/button-google-sign-in/button-google-sign-in.component.scss`,
  asi: `${COMPONENTS_FOLDER}/button-apple-sign-in/button-apple-sign-in.component.scss`,
  cbd: `${COMPONENTS_FOLDER}/combo-box/combo-box-dropdown/combo-box-dropdown.component.scss`,
  ...
  rlst: `${COMPONENTS_FOLDER}/radio-list/radio-list.component.scss`,
