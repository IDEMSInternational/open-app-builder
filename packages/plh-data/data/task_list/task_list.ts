...
const task_list: FlowTypes.Task_list[] = [
  {
    ...
    rows: [
      ...
      },
      {
        id: "task_relax",
        label: "Relax",
        groups_list: ["repeat_on_completion", "habits"],
        start_action: "start_new_flow",
        requires_list: ["task_mod_welcome_self-care_package"],
      ...
      },
      {
        ...
        groups_list: ["repeat_on_completion", "habits"],
        requires_list: ["task_mod_1on1_tips"],
      },
      {
      ...
      },
      {
        ...
        groups_list: ["repeat_on_completion", "habits"],
        requires_list: ["task_mod_welcome_quick_praise"],
      },
      {
      ...
      },
      {
        ...
        groups_list: ["repeat_on_completion", "habits"],
        requires_list: ["task_mod_stress_tips"],
      },
      {
      ...
      },
      {
        ...
        groups_list: ["repeat_on_completion", "habits"],
        requires_list: ["task_mod_budgeting_tips"],
      },
      {
      ...
      },
      {
        ...
        groups_list: ["repeat_on_completion", "habits"],
        requires_list: ["task_mod_responsibility_tips"],
      },
      {
      ...
      },
      {
        ...
        label: "Safe",
        groups_list: ["repeat_on_completion", "habits"],
        requires_list: ["task_mod_safe_tips"],
      },
      {
  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        requires_list: ["first_app_launch | delay_7_day"],
      },
      {
        ...
        requires_list: ["task_mod_1on1_emo"],
      },
      {
        ...
        requires_list: ["task_mod_1on1_intro"],
      },
      {
      ...
      },
      {
        ...
        requires_list: ["task_mod_1on1_tips | delay_1_day"],
      },
      {
        ...
        requires_list: ["task_mod_1on1_tips | delay_5_day"],
      },
      {
        ...
        requires_list: ["task_mod_1on1_activity | delay_4_day"],
      },
      {
      ...
      },
      {
        ...
        requires_list: ["task_mod_1on1_completed_goal", "first_app_launch | delay_14_day"],
      },
      {
        ...
        requires_list: ["task_mod_praise_intro"],
      },
      {
        ...
        requires_list: ["task_mod_praise_tips"],
      },
      {
        ...
        requires_list: ["task_mod_praise_tips | delay_1_day"],
      },
      {
        ...
        requires_list: ["task_mod_praise_tips | delay_7_day"],
      },
      {
        ...
        requires_list: ["task_mod_praise_activity | delay_4_day"],
      },
      {
      ...
      },
      {
        ...
        requires_list: ["task_mod_praise_completed_goal", "first_app_launch | delay_21_day"],
      },
      {
        ...
        requires_list: ["task_mod_instruct_par"],
      },
      {
        ...
        requires_list: ["task_mod_instruct_intro"],
      },
      {
        ...
        requires_list: ["task_mod_instruct_tips"],
      },
      {
        ...
        requires_list: ["task_mod_instruct_tips | delay_1_day"],
      },
      {
        ...
        requires_list: ["task_mod_instruct_tips | delay_5_day"],
      },
      {
        ...
        requires_list: ["task_mod_instruct_activity | delay_4_day"],
      },
      {
      ...
      },
      {
        ...
        requires_list: ["task_mod_instruct_completed_goal", "first_app_launch | delay_28_day"],
      },
      {
        ...
        requires_list: ["task_mod_stress_par"],
      },
      {
        ...
        requires_list: ["task_mod_stress_intro"],
      },
      {
      ...
      },
      {
        ...
        requires_list: ["task_mod_stress_tips | delay_1_day"],
      },
      {
        ...
        requires_list: ["task_mod_stress_tips | delay_5_day"],
      },
      {
        ...
        requires_list: ["task_mod_stress_activity | delay_4_day"],
      },
      {
