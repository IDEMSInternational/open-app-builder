...
const care_package_list: FlowTypes.Care_package_list[] = [
  {
    ...
    rows: [
      ...
      },
      {
        ...
        habit_list: ["habit_consequence", "habit_breathe"],
      },
      {
        id: "care_package_family",
        label: "Family care",
        habit_list: ["habit_money", "habit_safe"],
      },
    ],
    _xlsxPath: "plh_sheets_beta/ver_7_design/habits/care_packages.xlsx",
  },
];
export default care_package_list;
