      ...
      },
      {
        ...
        rows: [
          ...
          },
          {
            type: "text",
            message_text:
              "Look for anything your teen does that is helpful or good, and praise them. They may not show it, but you’ll see them doing that good thing again. It will also reassure them that you notice and care.",
          },
          {
            type: "list_item",
          ...
          },
          {
            type: "text",
            message_text:
              "Try to find something every day to thank them for. Even something really small.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        rows: [
          ...
          },
          {
            type: "text",
            message_text:
              'Often we know what we want in our head, but we don’t say it clearly enough. Say exactly what you want them to do. Try "please come home by 7pm" instead of "Come home in time".',
          },
        ],
      },
    ],
