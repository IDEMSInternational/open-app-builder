    ...
    rows: [
      {
        ...
        label: "Turning up",
        groups_list: ["hidden", "level_1"],
        completion_id_list: ["completion_open_app_level_1"],
      },
      {
        id: "goal_open_app_level_2",
        label: "Turning up",
        groups_list: ["hidden", "level_2"],
        requires_list: ["goal_open_app_level_1"],
        completion_id_list: ["completion_open_app_level_2"],
      },
      {
        id: "goal_relax_custom",
        label: "Relax",
        groups_list: ["hidden", "custom"],
        completion_id_list: ["completion_relax_custom"],
      ...
      },
      {
        ...
        groups_list: ["hidden", "custom"],
        completion_id_list: ["completion_praise_yourself_custom"],
      ...
      },
      {
        ...
        groups_list: ["hidden", "custom"],
        completion_id_list: ["completion_treat_yourself_custom"],
      ...
      },
      {
        ...
        groups_list: ["hidden", "custom"],
        completion_id_list: ["completion_spend_time_custom"],
      ...
      },
      {
        ...
        groups_list: ["hidden", "custom"],
        completion_id_list: ["completion_praise_teen_custom"],
      ...
      },
      {
        ...
        groups_list: ["hidden", "custom"],
        completion_id_list: ["completion_breathe_custom"],
      ...
      },
      {
        ...
        groups_list: ["hidden", "custom"],
        completion_id_list: ["completion_money_custom"],
      ...
      },
      {
        ...
        groups_list: ["hidden", "custom"],
        completion_id_list: ["completion_consequence_custom"],
      ...
      },
      {
        ...
        label: "Safe",
        groups_list: ["hidden", "custom"],
        completion_id_list: ["completion_safe_custom"],
        completion_tasks: "task_safe_custom_completed_goal",
      },
      {
        id: "goal_care_package_self",
        label: "Self care",
        groups_list: ["hidden", "care_packages"],
        completion_id_list: [
      ...
      },
      {
        ...
        label: "Teen care",
        groups_list: ["hidden", "care_packages"],
        completion_id_list: ["completion_spend_time_custom", "completion_praise_teen_custom"],
      ...
      },
      {
        ...
        groups_list: ["hidden", "care_packages"],
        completion_id_list: ["completion_consequence_custom", "completion_breathe_custom"],
      ...
      },
      {
        ...
        label: "Family care",
        groups_list: ["hidden", "care_packages"],
        completion_id_list: ["completion_money_custom", "completion_safe_custom"],
