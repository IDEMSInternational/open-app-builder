const data: { [source_text: string]: string } = {
  ...
  "Content coming soon": "Diteng di etla fa gautshwane",
  ...
  "You’ve not marked any @data.habit.instruct_positively.title @global.parent_points this week yet. \n\nGive it a try today!":
    "Ga o a tshwaya epe ya @data.habit.instruct_positively.title @global.parent_points mo bekeng eno ga jaana. \n\nE leke gompieno!",
  ...
  "You’ve marked the @global.parent_point @data.habit.instruct_positively.title @field.total_parent_point_instruct_positively times already  – so you’re making great progress.":
    "O setse o tshwaile @global.parent_point @data.habit.instruct_positively.title @field.total_parent_point_instruct_positively – go rialo o gatela pele sentle tota.",
  ...
  "Praise time! Look at your teen and praise them for one thing they are doing well! And when was the last time you praised yourself or another adult in your household? Try it!":
    "Nako ya go akgola! Leba mosha wa gago, mme o mo akgole ka sengwe se se molemo se a se dirang sentle! Ke leng la bofelo fa o ne o ikakgola kgotsa o akgola mogolo mongwe mo lelapeng la gago? Go leke!",
  ...
  "How will you support each other going forward? \n\nHere are some ideas from other families:":
    "Lo tlile go tshegetsana jang go ya ko pele? \n\nGo na le dikakantsho tseno tse di tswang kwa malapeng a mangwe:",
  MEET: "KOPANANG",
  ...
  "With teenagers – and in life – unexpected problems come up. \n\nHere are 4 problem-solving steps to do together.":
    "Ka basha - le mo botshelong - mathata a a sa lebelelwang a nna gone. \n\nFano ke dikgato di le 4 tsa go rarabolola mathata tse lo ka di dirang mmogo.",
  ...
  "How to support each other": "Kafa lo ka thusanang ka teng",
  ...
  "<p>This button takes you to the @global.parent_centre </p>\n\n<p>Stacked with the resources you need whenever you want. </p>\n\n<p> Instant access to help sections with @global.essential_tools for each skill.</p>\r\n\n<p> Extra information and local resources.</p>":
    "<p>Konopo eno e go isa ko @global.parent_centre </p>\n\n<p>Ko go nang le dilo tse o di tlhokang nako nngwe le nngwe. </p>\n\n<p> Go kgona go tsena ka bonako mo dintlheng tse di thusang tse di nang le @global.essential_tools ya bokgoni bongwe le bongwe.</p>\r\n\n<p> Tshedimosetso e e oketsegileng le ditlamelwa tsa selegae.</p>",
