const data: { [source_text: string]: string } = {
  ...
  "Content coming soon": "Diteng di etla gautshwane",
  ...
  "Ah yes, even 10 minutes together makes a big difference – that makes it easy to schedule it in, next to your work and chores!":
    "Ee ruri, le eleng metsotso e 10 re le mmogo e dira pharologano – seo se dira gore go nne motlhofo go e rulaganya, gaufi le tiro ya gago le mmereko wa legae!",
  ...
  "Did you have any challenges when trying to spend time with your teen?":
    "A o nnile le dikgwetlho dipe fela fa o leka go ipha nako le mosha wa gago?",
  ...
  "My teen only wants to watch TV or play on his/her phone.":
    "Mosha wa me o batla fela go lebelela TV kgotsa go tshameka ka founo ya gagwe.",
  ...
  "My teen wants to do things that I cannot physically do.":
    "Mosha wa me o batla go dilo tse nna ke se kitlang ke kgona go di dira ka mmele wa me.",
  ...
  "I struggled to end the one-on-one time.":
    "Ke sokotse go khutlhisa nako e ke iphang yone le ene.",
  "All my children want one-on-one time with me at the same time.":
    "Bana ba me botlhe ba batla ke ipha nako le bone ka nako e e tshwanang.",
  "Yes, it can be really hard to find time during the day, with work, chores, and everything else.":
    "Ee, go ka nna boima go nna le nako motshegare, ka tiro, ditiro tsa legae, le dilo tse dingwe tsotlhe.",
  "Sorry that you struggled with that. It can make us feel bad if our children do not want to spend one-on-one time with us.":
    "Re maswabi go bo o sokotse ka seo. Go ka utlwisa botlhoko tota fa bana ba rona ba sa batle go ipha nako le rona.",
  ...
  "Sit next to my teen when they are doing something they enjoy and show interest in what they like.":
    "Ke nna gaufi le mosha wa me fa ba dira sengwe se ba se ratang le go bontsha kgatlhego mo go se ba se ratang.",
  ...
  "Great! Picking a time when your teen is more talkative will help them to respond well to your attempt to connect.":
    "Go gontle! Go tlhopha nako e mosha wa gago a buang thata ka yone go tla ba thusa gore ba go tsibogele sentle fa o leka go ikgolaganya le bone.",
  "Nice! Watching your teen’s favourite T.V. show or sports match together will show them that you care. Just be patient; they will open up to you over time!":
    "Bontle! Go leba lenaneo la TV le mosha wa gago a le ratang kgotsa motshameko mmogo go tla ba bontsha gore wa ba kgathalela. Nna pelotelele; ba tla go bulela mafatlha fa nako e ntse e tsamaya!",
  ...
  "Suggest fun things my teen and I could do together.":
    "Akantsha dilo tsa go ijesa monate tse nna le mosha wa me re ka di dirang mmogo.",
  ...
  "Wonderful!  There are lots of fun and educational apps on phones that you can explore together. Ask questions, show interest, and remember to say something nice.":
    "Bontle tota!  Go na le didiriso tse dintsi tsa go ijesa monate le tsa thuto mo difounong tse lo ka di sekasekang mmogo. Botsa dipotso, bontsha kgatlhego, mme gopola go bua sengwe se sentle.",
  ...
  "Watch my teen do the activity and cheer them on.":
    "Lebelela mosha wa me a dira tiro e mme ke mo kgothatse.",
  ...
  "Yes, the end of one-on-one time can sometimes be difficult.":
    "Ee, go khutla ga nako e lo e iphileng mmogo go ka boima ka dinako tse dingwe.",
  ...
  "Many parents face this. It can be difficult to spend one-on-one time with our teens when we have more than one child.":
    "Batsadi ka bontsi ba lebana le seno. Go ka nna boima go ipha nako mmogo le basha ba rona fa e le gore re na le bana ba bangwe.",
  ...
  "Perfect! This way, you can give your undivided attention to your teen, so they feel valued and loved.":
    "Bontle tota! Ka tsela eno, o ka tlhoma mogopolo wa gago mo mosheng wa gago, gore ba ikutlwe ba le botlhokwa e bile ba ratiwa.",
  ...
  "Did you have any challenges when trying to introduce a consequence together?":
    "A o kile wa nna le dikgwetlho dipe fa o leka go itsise ditlamorago mmogo?",
  "What was difficult for you about introducing a consequence with your teen?":
    "Ke eng se se nnileng boima mo go wena ka go itsise mosha wa gago ka ditlamorago?",
  ...
  "When your teen gets angry, you might need to walk away until you are both calm. \n\nCheck to make sure your consequence is fair and reasonable. Listen to your teen’s explanation, and make sure to give a “Safety Amnesty” if they broke a rule in order to stay safe.":
    "Fa mosha wa gago a galefa, o ka nna wa tlhoka go mo katoga go fitlha loo-babedi lo kgobile makgwafo. \n\nTlhola go netefatsa gore ditlamorago tsa gago di tekatekano mme di a utlwala. Reetsa tlhaloso ya mosha wa gago, mme o netefatse go naya “Tshireletsego ya go Itshwarela” fa ba robile molao e le gore ba nne ba sireletsegile.",
  ...
  "We all make mistakes! The more consistent we are with our consequences, the more likely our children will choose to behave positively in the future.":
    "Rotlhe re dira diphoso! Fa re latela ditlamorago thata gaufiufi, ke moo thata bana ba rona ba tla tlhophang go itshwara sentle mo isagweng.",
  ...
  "We only created a negative consequence, not a positive consequence.":
    "Re dirile fela ditlamorago tse di sa siamang, e seng tse di siameng.",
  "It can be difficult to think of positive consequences sometimes. Positive consequences will encourage your teen to take more responsibility, and you will see the difference!":
    "Go ka nna boima go akanya ka ditlamorago tse di molemo nako enngwe. Ditlamorago tse di molemo di tla rotloetsa mosha wa gago go tsaya maikarabelo a oketsegileng, mme o tla bona pharologanyo!",
  ...
  "Teens can be used to seeing hitting as the only possible consequence for breaking rules. \n\nBrainstorm some calm consequences with them that could help them understand that they have done something wrong. These will be more effective and will set positive examples!":
    "Basha ba ka bona go itewa e le gone fela ditlamorago tsa go roba melao. \n\nAkantsha ditlamorago dingwe tse di seng thata le bone tse di ka ba thusang go tlhaloganya gore ba dirile sengwe se se sa siamang. Tseno di tla bereka thata mme e nne sekao se se molemo.",
  ...
  "prepare for a possible crisis with their teens":
    "rulaganya go santse go na le nako fa go ka tlhaga maemo a tshoganyetso le basha ba gago",
  ...
  "This is difficult stuff to talk about. Find a relaxing time for it. We know it is much easier to not talk about these things and to hope they will never happen to us. However, learning to deal with crisis is like getting insurance; it is ALWAYS best to think about them and be prepared.":
    "Seno ke selo se se boima go bua ka sone. Se batlele nako ya fa o kgobile makgwafo. Re a itse gore go motlhofo thata fa re sa bue ka dilo tseno e bile re solofela gore ga di kitla di re diragalela. Le fa go ntse jalo, go ithuta go lepalepana le mathata go tshwana le go batla inshorense; go botoka fa ka METLHA o akanya ka tsone mme o nna o ipaakantse.",
  "Your home practice was to try out REAL, POSITIVE and EXACT instructions with your teen.  We noticed you tapped the @data.habit.instruct_positively.in_text_title - great job for remembering!":
    "Ikatiso ya legae la gago e ne e le go leka ditaelo tsa NNETE, TSE DI SIAMENG le TSE  DI TSEPAMENG le mosha wa gago.  Re lemogile gore o tobeditse @data.habit.instruct_positively.in_text_title - o dirile sentle wa gopola!",
  ...
  "When we praise them, our teens feel encouraged to listen to us again!":
    "Fa re ba akgola, basha ba rona ba ikutlwa ba kgothetse go re reetsa gape!",
  ...
  "Did you have any challenges?": "A o kile wa nna le dikgwetlho?",
  ...
  "I did not find time to spend one-on-one time with my teen.":
    "Ga ke a kgona go bona nako ya go e e ipha le mosha wa me.",
  "I gave a negative instead of a positive instruction.":
    "Ke mo neile taelo e e sa siameng go na le e e siameng.",
  ...
  "Ask my teen or someone else to help me with a chore, so I have some extra free time.":
    "Botsa mosha wa me kgotsa mongwe o sele go nthusa ka tiro ya legae, gore ke kgone go nna le nako e oketsegileng ke sa dire sepe.",
  "Perfect! Even spending 5 minutes makes a big difference, and if you do it at the same time every day (like at breakfast or before bed), it will be easier to keep it up!":
    "Bontle tota! Le fa e le go ipha metsotso e 5 go dira pharologanyo e kgolo, mme fa o e dira ka nako e tshwanang tsatsi le letsatsi (jaaka fa re ja dijo tsa mo mosong kgotsa pele re ya go robala), go tla nna motlhofo go e latelela!",
  ...
  "Your goal was to make a family budget and savings plan.":
    "Mokgele wa gago e ne e le go dira thulaganyo ya tekanyetsokabo le go boloka madi ga lelapa.",
  "Thank you for sharing your experiences! Well done for thinking about how you can budget and save with your family. This will really help you to work towards your family goals. \n\nTogether you can achieve so many good things!":
    "Re lebogela go bo o re neile maitemogelo a gago! O dirile sentle ka go akanya ka kafa o ka dirang tekanyetsokabo le go boloka madi mmogo le lelapa la gago. Seno ruri se tla lo thusa tota gore lo berekele go fitlhelela mekgele ya lelapa. \n\nLo le mmogo lo ka kgona go fitlhelela dilo di le dintsi!",
  ...
  "Did you have any challenges when making your budget together?":
    "A lo nnile le dikgwetlho dipe fa lo dira tekanyetsokabo ya lona mmogo?",
  ...
  "I’m sorry to hear this. I know it can be difficult! Why don’t we go through it again? Your teen or other family members can join and help you!":
    "Ke maswabi go utlwa seno. Ke a itse go ka nna boima! Goreng re sa e leke gape? Mosha wa gago kgotsa maloko a mangwe a lelapa la gago ba ka ikopanya nao mme ba go thusa!",
  ...
  "Well done - great job for remembering!": "O berekile - o dirile sentle wa gopola!",
  ...
  "It happens - just be patient. Make sure to keep spending time with your teen, so they will value your opinion more and more. When your praise is genuine, you will see the benefits soon!":
    "Go a direga - nna pelotelele. Netefatsa gore o nna o ipha nako le mosha wa gago, gore ba bone boleng jwa pono ya gago le e leng go feta. Fa o ba akgola go tswa pelong, o tla bona matswela e se kgale!",
  ...
  "Did you have any challenges when trying to make a rule together?":
    "A o nnile le dikgwetlho dipe fa o leka go dira molao lo le mmogo?",
  "What was difficult for you about making a rule with your teen?":
    "Ke eng se se nnileng boima mo go wena ka go dira molao le mosha wa gago?",
  ...
  "Think about whether the rule is reasonable. Can your teen follow it? When making rules as a family, it helps to think about your teen, how old they are, and what is important to them.":
    "Akanya ka gore a mme molao o utlwala. A mosha wa gago o kgona go o latela? Fa lo dira melao jaaka lelapa, go thusa gore o akanye ka mosha wa gago, ba bagolo go le kae, le gore ke eng se se botlhokwa mo go bone.",
  ...
  "We should always remember that children learn best from us. The more we follow the rules, the more they will follow the rules, too. \n\nYou can adjust the rule to make sure that it is realistic for everyone to follow, considering your responsibilities and your teen’s responsibilities (for example, school or work activities).":
    "Re tshwanetse go gopola ka metlha gore bana ba ithuta thata go tswa mo go rona. Fa re latela melao thata, le bone ba tla o latela. \n\nO ka nna wa tokafatsa melao go netefatsa gore a kgonega gore botlhe ba e latele, o akanyetsa maikarabelo a gago le maikarabelo a mosha wa gago (ka sekai, sekolo kgotsa dilo tsa tiro).",
  ...
  "Sometimes it can be difficult to agree with everyone in the family, especially if everyone is not yet calm. You could agree to try one solution first, and then another. Also, if you get stuck, try to get together later to agree on the solution together.":
    "Ka dinako tse dingwe go ka nna boima go dumalana le batho botlhe mo lelapeng, segolo jang fa batho botlhe ba sa kgoba makgwafo. O ka dumalana go leka tharabololo e le nngwe pele, mme go latele e nngwe. Gape, fa o eme tlhogo, leka go nna mmogo kgantele go dumalana ka tharabololo mmogo.",
  ...
  "This week, your goal was: Whenever you are feeling stressed or upset, take five breaths in and out before you react.":
    "Beke eno, mokgele wa gago e ne e le gore: Fa o ikutlwa o tshwenyegile mo maikutlong kgotsa o tenegile, hemela ko teng le kwa ntle ga tlhano pele ga o ka tsaya kgato.",
  "How did this work out?": "Seno se ile sa berekega jang?",
  ...
  "How did this go?": "Seno se ile sa berekega jang?",
  "Did you experience any of these challenges when sharing how you feel with your teen?":
    "A o na le maitemogelo ka dikgwetlho tseno fa o bolelela mosha wa gago gore o ikutlwa jang ka ene?",
  "What was difficult for you about sharing how you feel with your teen?":
    "Ke eng se se nnileng boima mo go wena fa o bolelela mosha wa gago gore o ikutlwa jang ka ene?",
  ...
  "Sharing feelings, especially the difficult ones, sets an important example for your teen! It actually makes everyone in the family stronger, because you can understand and support each other better.":
    "Go bua maikutlo a gago, segolo jang a a boima, go tlhomela mosha wa gago sekao sa botlhokwa! Tota e bile go dira gore mongwe le mongwe mo lelapeng a tiye le go feta, ka ntlha ya gore lo kgona go tlhaloganyana le go tshegetsana botoka.",
  "I felt uncomfortable about naming specific difficult feelings.":
    "Ke ikutlwile ke sa nnisega ka go totobala ka maikutlo a a rileng a a boima.",
  "Being specific is not rude or insensitive - it really helps others to understand you clearly and this prevents confusion in the family. Feelings like anger and stress are part of our lives. All we need to do when we feel angry and stressed is handle our emotions well by taking a few deep breaths before responding.":
    "Go totobala ga e se go tlhoka maitseo kgotsa go sa amege - seno se thusa ba bangwe go go tlhaloganya sentle mme seno se dira gore go seke ga nna le go tlhakana tlhogo mo lelapeng. Go ikutlwa o galefile le go tshwenyega mo maikutlong ke karolo ya botshelo jwa rona. Se re tlhokang go se dira fa re galefile le go tshwenyega mo maikutlong ke go tshwara maikutlo a rona sentle ka go hemela ko teng makgetlo a le mmalwa pele o araba.",
  ...
  "Speak kindly to yourself about what a great job you are doing. There is no such thing as a perfect parent, and we think you’re doing great!":
    "Bua sentle le wena o ipolele gore o dira tiro e e molemo. Ga gona selo se se jaaka motsadi yo o itekanetseng, mme re akanya gore o dira sentle!",
  ...
  "You’ve marked the @global.parent_point @data.habit.instruct_positively.title once already  – so you’re making great progress.":
    "O setse o tshwaile @global.parent_point @data.habit.instruct_positively.title gangwe – ka gone o gatela pele sentle tota.",
  "You’ve marked the @global.parent_point @data.habit.instruct_positively.title @field.total_parent_point_instruct_positively times already  – so you’re making great progress.":
    "O setse o tshwaile makgetlo a le @global.parent_point @data.habit.instruct_positively.title @field.total_parent_point_instruct_positively – ka gone o gatela pele sentle tota.",
  ...
  "Hi @field.group_name! You are making such good progress on your parenting journey!\n\nHaving a teen means having a lot of unexpected problems to deal with. This workshop will show you all how to deal with them.":
    "Dumela @field.group_name! O dira kgatelopele e ntle tota mo loetong lwa gago lwa botsadi!\n\nGo nna le mosha go raya go nna le mathata a a sa lebelelwang a o tshwanetseng go lepalepana le bone. Workshop eno e tla lo bontsha lotlhe gore lo lepalepane jang le one.",
  ...
  "Well done for exploring solutions to your challenges. Go try them out. Your relationship with your teen will get stronger and stronger!":
    "O dira sentle ka go ithute ditharabololo tsa dikgwetlho tsa gago. Tsamaya o ye go di leka. Kamano ya gago le mosha wa gago e tla tiya le go eta!",
  ...
  "Top @local.number_of_challenges challenges other parents experience:":
    "Dikgwetlho tse @local.number_of_challenges tse dikgolo tse batsadi ba itemogelang tsone:",
  ...
  "Read Sbo's message": "Bala molaetsa wa ga Sbo",
  "Today's steps": "Dikgato tsa gompieno",
  "Question Time": "Nako ya Dipotso",
  "It's time for some questions!": "Ke nako ya go botsa dipotso!",
  "Read Together": "Bala Mmogo",
  "Let's read a story together!": "Tla re bale kgang mmogo!",
  "Let's read a story!": "Tla re bale kgang!",
  ...
  "Let’s do a short relaxation activity together – it will take less than 1 minute and you will feel more relaxed.":
    "A re dire tiro ya go iketla mmogo e khutshwane – e tla tsaya kafa tlase ga motsotso o le 1 mme o tla ikutlwa o iketlile le go feta.",
  "Add this activity to @global.my_relaxes": "Tsenya tiro eno go @global.my_relaxes",
  "Listen and relax": "Reetsa mme o iketle",
  "Read and relax": "Bala mme o iketle",
  ...
  Watch: "Leba",
  "Let's watch a video!": "A re lebe bidio!",
  ...
  "* You can’t always travel, but you can always dream! Ask your teen these questions:\n* Where would you want to travel to? How long would you be away? What would you pack? What would you do on your trip? What would you see?\n* Look at a map together or draw one.\n* Choose a country that your teen has never heard of and learn more about the country.":
    "* Ga go kgonege gore o nne o ntse o tsere mosepele, mme o ka nna wa lora ka metlha! Botsa mosha wa gago dipotso tseno:\n* O ka rata go tsaya mosepele wa go ya kae? Wa go tsamaya lobaka lo lo kae? O ka paka eng? O ka dira eng mo loetong lwa gago? O tla bona eng?\n* Lebelela mmapa mmogo kgotsa lo o terowe.\n * Tlhopha naga e mosha wa gago a iseng a e utlwalele mme lo ithute go le gontsi ka naga eo.",
  ...
  "* Think of three statements about yourself. Two must be true and one must be a lie.\n* It might help to think of wishes, dreams, experiences at school, likes or dislikes. For example: I hate bananas, my favourite subject is science, and I really wish I could sing. \n* Say them to your teenager and ask them to guess which one is a lie. \n* Did they guess correctly? Was it a surprise?\n* Now ask them to do the same. Did you learn something new about each other?":
    "* Akanya ka dipolelwana tse tharo ka wena. Tse pedi di tshwanetse go nna tsa nnete mme e nngwe e nne ya maaka.\n* Go ka nna ga thusa go akanya ka dikeletso, ditoro, maitemogelo a ko sekolong, tse di rategang kgotsa tse di sa rategeng. Ka sekai: Ke tlhoile dipanana, serutwa se ke se ratang ke saense, mme ke eletsa e kete nkabo ke kgona go opela. \n* Di bolelele mosha wa gago mme o ba kope go fopholetsa gore ke efe e e leng maaka. \n* A ba fopholeditse ka nepo? A o ne o maketse?\n* Jaanong ba kope ba dire se se tshwanang. A lo ithutile sengwe se sesha ka yo mongwe?",
  ...
  "* Ask each other questions. They can be any questions about things you like or what you did today.\n* The only rule is that you can’t answer “Yes”, “No” or “Maybe”.\n* How long can you last? How creative can you get with your answers?\n* Swap over and play again!":
    "* Botsanang dipotso. E ka nna dipotso dipe fela kaga dilo tse o di ratang kgotsa se o se dirileng gompieno.\n* Molawana o le nosi fela ke gore o ka se arabe ka “Ee”, “Nnyaa” kgotsa “Gongwe”.\n* O ka kgona go tsaya lobaka lo lo kae? O ka itirela dikarabo tse di kgatlhang jang?\n* Refosanang mme lo tshameke gape!",
  "* First person says, “On Saturday, I am going to… (e.g., go to the park)”\n* Second person adds to first person, “On Saturday, I am going to the park and… (e.g., visit my best friend).\n* Each person adds to the previous, trying to think of all of the fun things to do on Saturday.":
    "* Motho wa ntlha a re, “Ka Lamatlhatso, ke ya kwa... (s.k., ke ya kwa parakeng)”\n* Motho wa bobedi o tlatsa wa ntlha ka gore, “Ka Lamatlhatso, ke ya kwa parakeng le... (s.k., ke etela tsala ya me e kgolo).\n* Motho mongwe le mongwe o tlatsa yo o sa tswang go feta, ba leka go akanya ka dilo tsotlhe tse di itumedisang go ka di dira ka Lamatlhatso.",
  ...
  "* This game can be played in pairs or with many people in a group.\n* Stand facing each other or in a circle. \n* One person leads first and everyone else copies them, trying to move exactly at the same time as the leader.\n* Make sure the leader moves slowly enough for everyone else to follow! Explore moving different body parts and in different levels.\n* After a while, switch who is leading. Give everyone a chance to lead.\n* Try it with no leaders!":
    "* Motshameko ono o ka tshamekiwa ka dipara kgotsa le batho ba le bantsi mo setlhopheng.\n* Emang lo lebane kgotsa mo kgolokweng. \n* Motho a le nosi o etelela pele mme ba bangwe botlhe ba a mo etsa, ba leka go suta ka nako e le nngwe kgo le moeteledipele.\n* Netefatsa gore moeteledipele o suta ka iketlo ka mo go lekaneng gore mongwe le mongwe a mo latele! Bina ka tsela ya gore go sute mmele otlhe ka selekanyo se se farologaneng.\n* Morago ga sebaka, yo mongwe e nne ene a etelelang pele. Naya mongwe le mongwe tshono ya go etelela pele.\n * Leka seno go sena baeteledipele!",
  ...
  "* Think of a new skill you could learn together with your teen. For example, keeping a ball in the air or your foot, juggling, making soup?\n* Take turns in trying the new skill out.\n* Make sure to praise each other, and try to learn and play together!":
    "* Akanya ka botswerere jo bosha jo lo ka bo ithutang mmogo le mosha wa gago. Ka sekai, go boloka kgwele e le mo moweng kgotsa mo leotong, thefosano, go dira sopo?\n * Refosanang ka go leka bokgoni jo bosha.\n * Netefatsa gore lo a bakana, mme lo leke go ithuta le go tshameka mmogo!",
  ...
  "Choose a sport or exercise to do together. Decide on a schedule. Are you going to do it every day? For how long? \n\nTry it out for a week. At the end of the week, ask yourself and your family these questions:\n* How is it going? \n* How did you feel at the start of the week? \n* How do you feel at the end of the week? \n* What can we do differently next week?":
    "Tlhopha motshameko kgotsa ikatiso e lo ka e dirang mmogo. Dirang tshwetso ka thulaganyo. A lo tlile go dira seno tsatsi le letsatsi? Ka lobaka lo lo kae? \n\nE lekeng beke yotlhe. Kwa bowelong jwa beke, wena le lelapa la gago ipotseng dipotso tse di latelang:\n * Go tsamaya jang? \n * Lo ikutlwa jang kwa tshimologong ya beke? \n * Lo ikutlwa jang kwa bowelong jwa beke? \n * Ke eng se re ka se dirang ka tsela e e farologaneng beke e e latelang?",
  ...
  "At the end of a tough day, thinking of three things to be grateful for can help us find the courage to try again tomorrow.":
    "Morago ga letsatsi le le boima, akanya ka dilo tse tharo tse o di lebogelang go re thusa go bona bopelokgale jwa go leka gape kamoso.",
  ...
  "Close your eyes. \n\nUse the magic power of three to stay connected and relax.\n\nBreathe in to the count of three. 1, 2, 3. \nBreathe out to the count of three. 1, 2, 3. \nBreathe in to the count of three. 1, 2, 3. \nBreathe out to the count of three. 1, 2, 3.":
    "Tswala matlho a gago. \n\nDirisa maatla a boselamose a mararo go nna o le fano e bile o iketlile.\n\nHemela ko teng makgetlo a mararo. 1, 2, 3. \nHemela ko ntle makgetlo a mararo. 1, 2, 3. \nHemela ko teng makgetlo a mararo. 1, 2, 3. \nHemela ko ntle makgetlo a mararo. 1, 2, 3.",
  "Do you feel any different? Deep breathing helps our whole body and mind to calm down. \n\nYou are a star!":
    "A o utlwa pharologanyo? Go hemela ko teng go thusa mmele otlhe wa rona le mogopolo gore di ritibale. \n\nO naledi!",
  ...
  "When you are ready open your eyes again. You are in control!":
    "Fa go siametse go dira jalo bula matlho a gago gape. Ke wena o laolang!",
  ...
  "Close your eyes. \n\nDo your children ever make you feel like screaming? \n\nGive yourself a 10-second pause. Breath in and out slowly 5 times. \n\nThen try responding in a calmer way.":
    "Tswala matlho a gago. \n\nA bana ba gago ba a tle ba dire gore o batle go goeletsa? \n\nIphe metsotswana e 10 o eme go se kae. Hemela ko teng le ko ntle makgetlo a 5. \n\nMme leka go araba o kgobile makgwafo.",
  "Millions of parents say this helps - A LOT.":
    "Dimilione tsa batsadi di a re seno se a thusa - THATA.",
  ...
  "Hello! How are you feeling right now? Happy, sad, angry, excited, worried?\n\nNotice where you feel it in your body. Notice what thoughts are connected to that feeling. Take a deep breath.":
    "Dumela! O ikutlwa jang gone jaanong? O itumetse, o hutsafetse, o galefile, o kgatlhegile, o tshwenyegile?\n\nLemoga mo o e utlwang teng mo mmeleng wa gago. Lemoga gore ke dikakanyo dife tse di golaganeng le maikutlo ao. Wela makgwafo.",
  ...
  "Let’s practice a calming trick that we call ‘Pause Power’. \n\nPlant your feet on the ground and breathe in and out three times as slowly as you can. Imagine you are smelling a flower or blowing out a candle. \n\nTa Da! Pause Power!":
    "A re ikatise ka tsela ya go kgoba makgwafo e re e bitsang ‘Maatla a go Ema go se Kae’. \n\nBaya maoto a gago mo fatshe mme o hemele mo teng le ko ntle makgetlo a mararo ka bonya jo o ka bo kgonang. Akanya o nkga lelomo kgotsa o butswela kerese go e tima. \n\nTa Da! Maatla a go Emisa go se Kae!",
  "This is a great trick to use when you are feeling frustrated because it will help to calm you down.":
    "Eno ke tsela e e molemo ya go e dirisa fa o ikutlwa o tlhakane tlhogo ka gonne e tla go thusa go kgoba makgwafo.",
  "Self-praise can be really helpful, especially when we have difficult days. \n\nThink of your week and finish the following phrase: “This week, I am proud of myself for …” It can be anything, not just things about being a parent!\n\nThink of one thing you did well today. Now wrap your arms around yourself and give yourself a big HUG!":
    "Go ikakgola go ka go thusa tota, segolo jang fa re na le malatsi a a boima. \n\nAkanya ka beke ya gago mme o feleletse polelwana e latelang: “Beke eno, ke a ipela ka nna go bo...” e ka nna sengwe le sengwe, eseng fela dilo tse di amanang le go nna motsadi!\n\nAkanya ka sengwe se le nosi se o se dirileng gompieno. Jaanong itlamparele ka matsogo a gago mme o iphe TLAMPARELO e kgolo!",
  ...
  'Step 1. Close your eyes and take a deep breath. \n\nStep 2. Ask yourself, "What am I thinking?" Notice if your thoughts are positive or negative.\nNotice how you are feeling emotionally. Notice if your emotions are pleasant or unpleasant. Remind yourself that whatever you feel, it is okay.\nNotice how your body feels. Notice anything that hurts or is tense.\n\nStep 3. Focus on your breath. Feel your breath as it goes in and out. You can put a hand on your stomach and feel it rise and fall with each breath. Do this for about 10 breaths.\n\nStep 4. Expand your awareness to your whole body. Listen to the sounds in the room. \n\nStep 5. Take a moment to reflect on whether you feel any different. When you are ready, open your eyes.':
    "Kgato 1. Tswala matlho mme o hemele ko teng. \n\nKgato 2. Ipotse, “Ke akantse ka eng?” Lemoga fa dikakanyo tsa gago di siame kgotsa di sa siama.\nLemoga kafa o ikutlwang ka gone mo maikutlong. Lemoga fa maikutlo a gago a siame kgotsa a sa siama. Ikgopotse gore go sa kgathalesege gore o ikutlwa jang, go siame.\nLemoga kafa mmele wa gago o ikutlwang ka gone. Lemoga fa sengwe se le botlhoko kgotsa se gagametse.\n\nKgato 3. Tlhoma mogopolo mo tseleng e o hemang ka yone. Reetsa tsela e o hemang ka yone o ntse o tsenya mowa o bo o o ntsha. O ka nna wa baya letsogo mo mpeng ya gago mme o e utlwe fa e ya ko godimo le ko tlase fa o ntse o hema. Dira seno o hema ga 10.\n\nKgato 4. Atolosa temogo ya gago mo mmeleng otlhe wa gago. Reetsa medumo e e mo kamoreng. \n\nKgato 5. Tsaya motsotso go bona fa o utlwa pharologanyo epe. Fa go siametse go dira jalo, bula matlho a gago.",
  ...
  "Well done! You can do this activity at any time whenever you feel like you need to release stress and energise your mind and body.":
    "O dirile sentle! O ka dira tiro eno gape nako nngwe le nngwe fa o ikutlwa o tlhoka go ntsha go tshwenyega mo maikutlong mme o neye tlhaloganyo ya gago le mmele wa gago maatla.",
  ...
  "When you take care of yourself, you take care of your children. We all need to connect. Try to talk to friends, family, and other support networks every day. If it has been a while since you reached out to someone, do it now!":
    "Fa o itlhokomela, o tlhokomela le bana ba gago. Rotlhe re tlhoka go ikgolaganya. Leka go bua le ditsala, balelapa, le netweke tse dingwe tsa tshegetso tsatsi le letsatsi. Fa ele gore ke kgale o sa bue le mongwe, bua le bone jaanong!",
  ...
  "Being a parent can be so hard. Sometimes it feels like our children never listen to us.\n\nBut science shows that spending just a few minutes each day of focused one-on-one time with your teen helps build trust and love.":
    "Go nna motsadi go ka nna boima. Nako tse dingwe go utlwalega e kete bana ba rona ga ba re reetse.\n\nMme saense e bontsha gore go ipha metsotso e se kae tsatsi le letsatsi o tlhomile mogopolo mo nakong e o iphang yone le mosha wa gago lo le babedi go thusa go aga tshepo le lerato.",
  ...
  "Find 5 minutes (or more!) each day when your teen does not have something else they want to do.":
    "Batla metsotso e 5 (kgotsa go feta!) tsatsi le letsatsi fa mosha wa gago a sena sepe se a batlang go se dira.",
  ...
  "Tell your teen that you would like to spend some time with them and that they can choose what to do or talk about. They might think this is weird at first, but will come to enjoy this time with you!":
    "Bolelela mosha wa gago gore o ka rata go senya nako le ene le gore ba tlhophe gore ba batla go dira eng kgotsa go bua ka eng. Ba ka tsaya seno se sa tlwaelega ko tshimologong, mme ba tla itumelela nako eno le wena!",
  ...
  "Spend 5-20 minutes of one-on-one time with your teen, every day you can this week.":
    "Iphe metsotso e 5-20 le mosha wa gago lo le babedi, letsatsi lepe le o ka le kgonang mo bekeng eno.",
  "Remember - whenever you can, relax, recognise and reward yourself. \n\nCare for yourself every day. You matter!":
    "Gopola - nako epe fa o kgona, iketle, gakologelwa o bo o iteboge. \n\nItlhokomele letsatsi le letsatsi. O botlhokwa!",
  ...
  "We are so proud of you. You have shown strength, courage, and love for your family. Parents are amazing. You are amazing. \n\nThis song is for parents everywhere. Listen, dance together and celebrate yourselves!":
    "Re motlotlo tota ka lona. O bontshitse maatla, bopelokgale le lorato mo lelapeng la gago. Batsadi ba molemo. O molemo. \n\nPina eno ke ya batsadi gotlhe. Reetsa, binang mmogo mme lo keteke!",
  ...
  "Self-care is a key parenting tool.": "Go itlhokomela jaaka motsadi ke thulusu ya botlhokwa.",
  ...
  "Greetings, everyone. \n\nToday's topic is calm consequences.\n\nIt is important that when we introduce consequences to our teenagers we involve them, but also important that we are calm when we introduce consequences.\n\nThat will assist in us to agree on introducing calm consequences to our teenagers and our teenagers will easily remember them when they are involved and that will make them responsible.":
    "Dumelang, lotlhe. \n\nSetlhogo sa gompieno ke ditlamorago tse di ritibetseng.\n\nGo botlhokwa gore fa re itsise basha ba rona ditlamorago re ba tsenyeletse, mme fela gape sa botlhokwa ke gore re nne re kgobile makgwafo fa re ba itsise ditlamorago.\n\nSeo se tla thusa mo go rona gore re dumalane ka go itsise ditlamorago tse di ritibetseng mo basheng ba rona mme basha ba rona ba tla kgona go di gopola motlhofo fa re ba tsenyeletsa mme seo se tla dira gore ba nne le maikarabelo.",
  ...
  "Consequences are not quite the same as punishment: they give our teens a chance to learn responsibility for their actions.\n\nAnd they are more controlled AND effective than hitting or shouting!":
    "Tota ditlamorago ga di tshwane kgo le kotlhao: tsone di naya basha rona tshono ya go ithuta gore ke bone ba rwalang maikarabelo a se ba se dirang.\n\nO ka kgona go di laola E BILE di mosola go feta go itaya kgotsa go goelela!",
  ...
  "How you introduce calm consequences is important. Remember, when you involve your teen, things usually go better!":
    "Tsela e o itsiseng ka yone ditlhamorago o ritibetse maikutlo e botlhokwa. Gakologelwa gore, fa o tsenyeletsa mosha wa gago, gantsi dilo di nna botoka!",
  EXPLAIN: "TLHALOSA",
  ...
  "When your teen follows the rule, give praise and privileges!":
    "Fa mosha wa gago a ikobela molao o o o beileng, mmake o bo o mo neye ditshiamelo!",
  "They will feel respected and valued. Remember: The more we praise them, the more they will show that good behaviour!":
    "Ba tla bona gore wa ba tlotla e bile o ba tsaya ba le botlhokwa. Gakologelwa: Fa re nna re ba baka, ba tla nna ba bontsha boitshwaro joo jo bo siameng!",
  ...
  "When your teen breaks the rule, calmly give the consequence. This should be FAIR (not too harsh), IMMEDIATE (do it straight away) CONSISTENT (same every time).":
    "Fa mosha wa gago a tlola molao, mo neya ditlamorago o ritibetse. O tshwanetse go dira jalo ka TEKATEKANO (o se makgwakgwa), KA BONAKO (o se ka wa okaoka) O SA FETOGE (dira se se tshwanang ka metlha).",
  ...
  "All families experience crises. When we prepare together and know where to get help BEFORE something bad happens, we can overcome any crisis.":
    "Malapa otlhe a na le mathata a one. Fa re ipaakanyetsa mmogo e bile re itse gore re ka bona thuso kae PELE ga sengwe se se maswe se diragala, re ka kgona go fenya mathata ape fela.",
  ...
  "* Story & discussion\n* Story & discussion\n* Tools: How to deal with crisis\nBREATHE - LISTEN - THINK\n* Try it out!\n* Home practice suggestions":
    "* Polelo le motlotlo\n* Polelo le motlotlo\n* Dithulusu: Kafa o ka lepalepanang ka teng le mathata a a masisi\nKGWA MOWA - REETSA - AKANYA\n* E leke!\n * Dikakantsho tsa katiso ya legae",
  "* Story & reflection\n* Story & reflection\n* Tools: How to deal with crisis\nBREATHE - LISTEN - THINK\n* Try it out!\n* Home practice suggestions":
  ...
  "Yes, @global.w_crisis_female_caregiver actually used all those skills – and so can you!":
    "Tota @global.w_crisis_female_caregiver o dirisitse bokgoni jotlhe jo re setseng re bo buile – mme le wena o ka kgona!",
  ...
  "You’ve completed this week’s workshop. \n\nNext week’s workshop will celebrate you, and you can choose the support you want going forward. \n\nYou can prepare a treat to celebrate – something you like to eat, or music you like to listen to!":
    "O feditse workshop ya beke eno. \n\nWorkshop ya beke e e latelang re tla keteka kaga lona lotlhe, mme lo ka bua gore ke eng se lo batlang go tswelela lo thusiwa ka sone. \n\nLo ka rulaganya go tla ka sengwe se lo tla se itumelelang go keteka – gongwe dijo kgotsa mmino o lo ka ratang go o reetsa!",
  ...
  "Discuss together: \n\n* How did @global.w_instruct_teen_girl and @global.w_instruct_female_caregiver feel now?\n* Why do you think the situation went better for @global.w_instruct_female_caregiver this time?":
    "Tlotlang mmogo: \n\n* @global.w_instruct_teen_girl le @global.w_instruct_female_caregiver ba ikutlwa jang jaanong?\n* Goreng o akanya gore dilo di ile tsa tsamaela @global.w_instruct_female_caregiversentle mo lekgetlong leno?",
  ...
  "@global.w_instruct_teen_girl felt respected and loved by her @global.w_instruct_female_caregiver":
    "@global.w_instruct_teen_girl o ne a bona gore @global.w_instruct_female_caregiver o a mo tlotla e bile o a mo rata",
  "@global.w_instruct_female_caregiver was able to stay calm":
    "@global.w_instruct_female_caregivero ile a kgona go ritibala maikutlo",
  "@global.w_instruct_female_caregiver kept a positive attitude":
    "@global.w_instruct_female_caregiver a tswelela a bua ka tsela e e siameng",
  ...
  "Can your teen actually do what you are about to ask? It may be impossible for them to read quietly all day, but half an hour when you really need it is realistic.":
    "A mme gone ngwana wa gago wa dingwaga tsa bosha a ka kgona go dira se o mo kopang gore a se dire? Go ka nna ga se ka ga kgonega gore a tlhole a bala letsatsi lotlhe, mme tota a ka kgona go bala selekanyo sa halofo ya ura, seno se ka kgonega.",
  ...
  "Smile, look them in the eye, and use positive words. Praise them as soon as they start to do what you ask!":
    "Nyenya, mo lebe mo matlhong o bo o dirise mafoko a a siameng. O se ka wa okaoka go ba baka fa ba dira sengwe se o kopang gore ba se dire!",
  ...
  "Often we know what we want in our head, but we don’t say it clearly enough. Say exactly what you want your teen to do. Try ‘please come home by 7pm’ instead of ‘come home in time’.":
    "Go le gantsi le fa re itse gore ke eng se re se batlang, go nna thata go itlhalosa sentle. Bolelela mosha wa gago ka tlhamalalo gore ke eng se o batlang a se dira. Leka go mmolelela jaana, ‘tsweetswee fitlha mo lapeng ka 7pm’ go na le go mmolelela fela o re ‘tla gae ka nako’.",
  ...
  "* I like your music. Could you turn it down during dinner so that we can talk? Thank you – I really appreciate it. \n* That’s great music. Who is the singer? Please turn the music off when you come in the house. You can play it in your room quietly if you want. Thank you!":
    "* Ke rata mmino o o o reetsang. A o ka o tima fa re ja maitseboa gore re kgone go tlotla? Ke a leboga – Ke anaanela seo thata. \n* Mmino oo o monate tota. Ke mang a e opelang? Ke kopa o time mmino fa o tsena mo ntlong. O ka o reetsa kwa kamoreng ya gago fa o batla. Ke a leboga!",
  ...
  "Many families are stressed about money, especially if teens keep asking for things! \n\nWhen we make a budget together, we can agree how to spend AND save to prevent stress and work towards our family’s goals.":
    "Malapa a le mantsi a a tshwenyegile thata ka ntlha ya madi, bogolo jang fa basha ba nna ba kopa go rekelwa dilo! \n\nFa re dira tekanyetsokabo mmogo, re ka dumalana gore re tla dirisa madi jang LE GORE re tla boloka bokae gore re se ka ra iphitlhela re tshwenyegile e bile re ka kgona go fitlhelela mekgele ya rona re le lelapa.",
  ...
  "* Story – that didn’t work… \n* Budgeting exercise\n* Story & discussion – that worked!\n* Story & discussion – that didn’t work…\n* Discussion on saving options\n* Saving exercise\n* Tools: How to budget & save\nTHINK - CHOOSE - BUILD - PLAN\n* Home practice suggestions":
    "* Polelo – Eo ga e a bereka... \n* Ikatiso ya tekanyetsokabo\n* Kgang le motlotlo - tse di berekileng!\n* Kgang le motlotlo - tse di sa berekang...\n* Motlotlo le ditlhopho tsa go boloka\n* Ikatiso ya tekanyetsokabo\n* Dithulusu: Kafa o ka dirang ka teng tekanyetsokabo le go boloka madi\nAKANYA - TLHOPHA - AGA - ITHULAGANYE\n * Dikakantsho tsa katiso ya legae",
  ...
  '"My goal is to make sure my grandson can go to high school and my granddaughter can reach her dream of university. How can I save a lot of money with the little money I have?"':
    "“Mokgele wa me ke gore setlogolo sa me sa mosimane se kgone go ya kwa sekolong se segolwane le gore setlogolo sa me sa mosetsana se kgone go fitlhelela mokgele wa go ya yunibesithi. Nka kgona jang go boloka madi a mantsi ke amogela madi a mannye jaana?”",
  ...
  '"I should also speak with my grandchildren to choose things that we can spend just a little bit less on each week. They will help me think of things we want but don’t need."':
    "“E bile ke tshwanetse go tlotla le ditlogolo tsa me gore ke dilo dife tse re ka dirisang madi a le mannye mo go tsone beke le beke. Ba tla nthusa go bona gore ke dilo dife re di batlang mme tota e se tse re di tlhokang.”",
  ...
  "Such a great goal! \n\nBy making a good budget and saving plan, you can achieve it and feel proud of yourself!":
    "Ke mokgele o montle tota! \n\nFa re dira tekanyetsokabo e e siameng e bile re rulaganya dilo mmogo, re ka fitlhelela mekgele ya rona e bile re tla ikutlwa re le motlotlo!",
  ...
  "Let's think about this story.": "A re bueng ka kgang eno.",
  "For @global.w_money_grandma, a storm happened.":
    "@global.w_money_grandma o ne a senyediwa ke setsuatsue.",
  ...
  "Emergencies can happen in any family. Saving some money for these emergencies BEFORE they happen prevents a lot of sudden worry and stress!":
    "Maemo a tshoganyetso a ka diragalela lelapa lengwe le lengwe. Go boloka madi GO SA LE NAKO gore re tle re e a dirisetse maemo ano a tshoganyetso go re thusa gore re se ka ra iphitlhela re tlaletswe e bile re gateletswe mo maikutlong fa a tlhaga!",
  ...
  "Discuss together: \n* In which different ways can we save?  \n* What are the advantages and disadvantages of each savings option? \n\nUnderstanding each option well will help you to decide what is the best saving option for your family.  \n\nWhatever savings plan you choose, it will really help your family move forward!":
    "Tlotlang mmogo: \n* Lo ka boloka madi ka ditsela dife tse di farologaneng?  \n* Ke diphelelo dife tse di molemo le diphelelo tse di seng molemo tsa mokgwa mongwe le mongwe wa go boloka madi? \n\nFa o tlhaloganya mokgwa mongwe le mongwe sentle, seno se tla go thusa gore o dire tshwetso ya gore ke mokgwa ofe wa go boloka madi o o siametseng lelapa la lona.  \n\nMokgwa ope fela o lo o tlhophang o tla thusa lelapa la lona gore le simolole go dira dilo ka tsela e e siameng!",
  ...
  "Plan how you can save money, so you can deal with emergencies and realise your family goals!":
    "Dirang dithulaganyo tsa gore lo ka boloka madi jang gore lo kgone go a dirisa ka nako ya maemo a tshoganyetso le go fitlhelela mekgele ya lelapa la lona!",
  ...
  "CONGRATULATIONS!!! You’ve made your family budget – and using it will make a huge difference for you. I think every person in your group deserves a praise, don’t you?":
    "LO DIRILE BONTLE TOTA!!! Lo dirile tekanyetsokabo ya lelapa la lona – mme fa lo e dirisa, e tla lo thusa fela thata. Re motlotlo ka mongwe le mongwe mo ditlhopheng tseno?",
  "CONGRATULATIONS!!! You’ve made your family budget – and using it will make a huge difference for you. I think every person in your family deserves a praise, don’t you?":
    "LO DIRILE BONTLE TOTA!!! Lo dirile tekanyetsokabo ya lelapa la lona – mme fa lo e dirisa, e tla lo thusa fela thata. Re akanya gore mongwe le mongwe mo lelapeng la lona o tlhoka go bakwa, a ga go jalo?",
  ...
  "Emergencies and family goals": "Maemo a tshoganyetso le mekgele ya lelapa",
  ...
  "Make a budget again - this time WITH your teen and family! \n\nThis is an important and fun thing to do with your family - it takes about 30 minutes.\n\nMaking a budget together helps teens understand that we all need to make hard decisions sometimes - but that it helps us have enough money at the end of the month and realise our goals!\n\nBudgets have helped  millions of families.":
    "Dira tekanyetsokabo gape - mo lekgetlong leno e dire LE mosha wa gago le lelapa la gago! \n\nKe selo se se itumedisang e bile se le botlhokwa go se dira le lelapa la gago - go tla tsaya metsotso e ka nna 30.\n\nGo dira tekanyetsokabo mmogo go thusa basha go lemoga gore rotlhe re tlhoka go dira ditshwetso tse di thata ka dinako dingwe - mme gone, e re thusa go nna le madi a a lekaneng fa kgwedi e fela e bile e re thusa gore re kgone go fitlhelela mekgele ya rona!\n\nDitekanyetsokabo di thusitse malapa a le mantsi tota.",
  ...
  "“Thank you for those great ideas! Yes, let me ask my teen to show how his phone works tomorrow after school. Can one of you pretend to be my teen now, so I can practice asking?”":
    "“Re lebogela dikakantsho tseo tse di molemo tota! Go siame, ke tla kopa mosha wa me gore a mpontshe gore founo ya gagwe e bereka jang fa a tswa sekolong. Ke mang yo o batlang go tshameka karolo ya go nna mosha wa me gore re dire ikatiso ke mo kopa?”",
  "Think about how your home activities went this week. \n\nTake turns to discuss:\n\n* What went well and what was a problem?\n* What solutions can you think of together?\n* Pick one solution and try it later with your teen! \n\n(Or you can even practice it now  so it will be easier later!)":
  ...
  "Praise is a powerful parenting skill.\n\nIf we praise our teens when they do something well, we will see them do more and more positive things!":
    "Go baka ke selo se se botlhokwa thata fa o godisa bana.\n\nFa re baka bana ba rona fa ba dirile sengwe sentle, ba tla nna ba tokafatsa thata!",
  "Greetings everyone. \n\nOur topic today is about praise. \n\nIt is good to praise our children when they've done good because when we do that, they will do more of that good behavior we want to see. \n\nAnd let's not forget to praise ourselves when we do good too!":
    "Dumelang lotlhe. \n\nGompieno re tlile go bua ka go baka. \n\nGo botlhokwa go baka bana ba rona fa ba dirile bontle ka gonne fa re dira jalo, ba tla tswelela ba tokafatsa mo go se re batlang gore ba se dire. \n\nMme a le rona re se ka ra lebala go ipaka fa re dirile bontle!",
  "* Effects of praise\n* Story & discussion – that worked!\n* Tools: How to praise\nSEE IT - SAY IT - REPEAT IT\n* Try it out!\n* Home practice suggestions":
    "* Matswela a go baka\n* Kgang le motlotlo - tse di berekileng!\n* Dithulusu: Tsela ya go baka\nBONA - BUA - BOELETSA\n* E leke!\n * Dikakantsho tsa katiso ya legae",
  "* Effects of praise\n* Story & reflection – that worked!\n* Tools: How to praise\nSEE IT - SAY IT - REPEAT IT\n* Home practice suggestions":
    "* Matswela a go baka\n* Kgang le go leba kwa morago - tse di berekileng!\n* Dithulusu: Tsela ya go baka\nBONA - BUA - BOELETSA\n * Dikakantsho tsa katiso ya legae",
  "Share with each other:\n\n* When last did someone thank you or say you did something great? \n* How did it make you feel? \n* How does it feel if you are not thanked or praised for what you do? \n\nWe usually don’t get thanked or praised enough as parents. Maybe you can give your teens the right example and praise them first when they do something well!":
    "Abelana le ba bangwe:\n\n* O feleleditse leng go utlwa mongwe a go leboga kgotsa a re o dirile sengwe se se ntle? \n* O ne o ikutlwa jang? \n* O ikutlwa jang fa o sa lebogiwe kgotsa o sa bakwe ka ntlha ya se o se dirileng? \n\nRona batsadi ga se gantsi re lebogiwa kgotsa re bakwa ka mo go lekaneng. Gongwe o ka tlhomela basha ba gago sekao se se molemo ka go ba baka fa ba dirile sengwe sentle lekgetlo la ntlha!",
  ...
  "Parents usually don’t get thanked or praised enough.":
    "Rona batsadi ga se gantsi re lebogiwa kgotsa re bakwa ka mo go lekaneng.",
  ...
  "Your teen can feel this way too. That's what makes this week's parenting tool simple but important: Praise them for what they do right.":
    "Mosha wa gago le ene a ka ikutlwa jalo. Ke sone se se dirang gore ikatiso ya rona ya beke eno e nne botlhokwa le fa gone e lebega e le motlhofo: Ba bake fa ba dirile sengwe sentle.",
  ...
  "How did praise make @global.w_praise_female_caregiver_name's teens feel?":
    "Go bakwa go ile ga dira gore basha ba ga @global.w_praise_female_caregiver_name ba ikutlwe jang?",
  "Why did she praise them?": "Goreng a ile a ba baka?",
  ...
  "Look for anything your teen does that is helpful or good, and praise them for it. They may not show it, but you’ll see them doing that good thing again. It will also reassure them that you notice and care.":
    "Leka go bona gore ke eng se se siameng e bile se go thusa se basha ba gago ba se dirang mme o ba bake. Gongwe ba ka nna ba se go bontshe gore ba a itumela mme gone, o tla ba bona ba dira selo seo se se sentle gape. Gape seno se tla dira gore ba lemoge gore o a bona gore ba dira bontle e bile o amega ka bone.",
  "SAY IT": "BUA",
  ...
  "You can also praise other adults in your household, too. Notice how they respond!":
    "Tota e bile le ba bangwe ba ba godileng mo lapeng o ka ba baka. Ela tlhoko gore ba itshwara jang fa o ba baka!",
  "Let's practice giving praise.": "A re direng ikatiso ya go baka.",
  "Share with each other: \n\n* What can you praise your teen for? \n* What has someone else done well during this workshop? Tell them!\n* How did it make you feel to praise someone?\n* How did it make you feel to be praised?":
    "Abelana le ba bangwe: \n\n* O ka baka mosha wa gago ka ntlha ya eng? \n* Ke eng se mongwe o sele a se dirileng sentle ka nako ya workshop eno? Ba bolelele!\n* O ile wa ikutlwa jang fa mongwe a go baka?\n* O ile wa ikutlwa jang fa o bakwa?",
  "Sometimes it’s hard to think of what to praise your teen for! Here are some ideas from other parents:":
    "Ka dinako tse dingwe go thata go akanya gore o ka baka mosha wa gago fa a dirile eng! Go na le dikakantsho tseno tse di tswang kwa batsading bangwe:",
  ...
  "This week's home practice is to praise your teen once a day. It will only take 10 seconds!":
    "Ikatiso ya kwa gae ya beke eno ke go baka mosha wa gago gangwe mo letsatsing. E tlile go tsaya fela metsotswana e le 10!",
  ...
  "How do you think @global.w_rules_teen_boy knew his @global.w_rules_female_caregiver_1 appreciated him?":
    "O akanya gore @global.w_rules_teen_boy o itsitse jang gore @global.w_rules_female_caregiver_1 wa gagwe o a mo anaanela?",
  ...
  '@global.w_safe_teen_girl_3: “@global.w_safe_teen_girl_1 don’t go! Be careful! Let’s go home. It is dangerous to go with people you don’t know. Besides, he’s too old for you and what he is doing is wrong."\n\n@global.w_safe_teen_girl_1: “I just don’t know…”':
    '@global.w_safe_teen_girl_3: “@global.w_safe_teen_girl_1 o seka wa tsamaya! Ikele tlhoko! A reye gae. Go kotsi go tsamaya le batho ba o sa ba itseng. Ntle le moo, o motona mo go wena e bile se a se dirang ga se a siama."\n\n@global.w_safe_teen_girl_1: “Tota ga ke itse...”',
  ...
  "* The man in the car was pressuring  @global.w_safe_teen_girl_1 with gifts \n* @global.w_safe_teen_girl_1's friend was encouraging her  \n* Going with an older man puts @global.w_safe_teen_girl_1 in a dangerous situation where she can get hurt or be forced to do things \n* Many girls in our communities get pregnant or catch HIV from older men \n* There were no other trusted adults to advise @global.w_safe_teen_girl_1":
    "* Monna yo o mo koloing o ne a gatelela @global.w_safe_teen_girl_1 ka go mo rekela dimpho \n* Tsala ya ga @global.w_safe_teen_girl_1 e ne e mo kgothaletsa  \n* Go tsamaya le monna yo motona go ne go tsenya @global.w_safe_teen_girl_1 mo boemong jo bo kotsi mo a neng a ka gobala kgotsa a patelediwa go dira dilo \n* Basetsana ba le bantsi mo lefelong la rona ba a ima kgotsa ba tsenwa ke HIV ka ntlha ya banna ba batona \n* Go ne go sena batho ba ba ikanyegang ba bagolo gore ba mo fe kgakololo @global.w_safe_teen_girl_1",
  ...
  "There were no other trusted adults to advise @global.w_safe_teen_girl_1":
    "Go ne go sena batho ba ba ikanyegang ba bagolo gore ba mo fe kgakololo @global.w_safe_teen_girl_1",
  "All those things are true!": "Dilo tseo tsotlhe di boammaaruri!",
  ...
  '@global.w_safe_teen_girl_1: "My friend has been talking with a guy our age online... She’s going to send him photos of herself. Is that better because he’s our age?"':
    "@global.w_safe_teen_girl_1: “Tsala ya e e ntse e bua le mosimane wa thaka ya rona mo inthaneteng... O tlile go mo romelela ditshwantsho tsa gagwe. A go botoka ka gonne ke thaka ya rona?”",
  '@global.w_safe_female_caregiver: "You are a good friend for being worried about her. Sending sexy photos is a real risk too."':
    "@global.w_safe_female_caregiver: “O tsala e e molemo go bo o amegile ka ene. Go romela ditshwantsho o sa apara go kotsi tota.”",
  '@global.w_safe_female_caregiver: "Sometimes people aren’t who they say they are online – he could say he is your age but be a 50 year old man. Or when they break up, he could send those photos to everyone and your friend would feel awful."':
    "@global.w_safe_female_caregiver: “Ka dinako tse dingwe batho ga ba a nna jaaka ba bua mo inthanete - a ka nna a re ke thaka ya gago kante ke monna wa dingwaga tse 50. Kgotsa fa ba kgaogana, a ka nna a romela ditshwantsho tseo kwa bathong botlhe e be tsala ya gago e utlwa botlhoko.”",
  ...
  "Let’s make two maps together of safe and unsafe places: \n* A map of our community \n* A map of apps/websites we use online \n\nYou’ll do the same with your teen as home practice this week - if your teen is here now, you can do it together now!":
    "A re direng dimmapa tse pedi mmogo tsa mafelo a a babalesegileng le a a sa babalesegang: \n* Mmapa wa motse wa rona \n* Mmapa wa ditiriso/diwebosaete tse re di dirisang mo inthaneteng \n\nLo tla dira se se tshwanang le mosha wa gago e le katiso ya legae mo bekeng eno - fa mosha wa gago a fano ga jaana, lo ka dira seno mmogo gone jaanong!",
  ...
  "Step 1: What are important places in your community?":
    "Kgato 1: Ke mafelo afe a botlhokwa mo lefelong la lona?",
  "* Get a piece of paper (or old newspaper or a cardboard box) and a pen. \n* Draw a map of your teen’s community, with pictures of all the main places like streets, your house, school, shops, places your teen visits.":
    "* Batla pampitshana (kgotsa lekwalodikgang la kgale kgotsa bokose ya khateboto) le pene. \n* Terowa mmapa wa lefelo le mosha wa gago a nnang mo go lone, o o nang le ditshwantsho tsa mafelo otlhe a botlhokwa jaaka ditsela, ntlo ya gago, sekolo, mafelo a ngwana wa gago wa dingwaga tsa bosha a a etelang.",
  ...
  "Make MAPS with your teen of safe and unsafe areas in your community and online. Talk about how to keep their information, photos and videos private online. Talk about how once something goes online, it stays there forever. They might know an example from their friends.":
    "Dira DIMMAPA le mosha wa gago tsa mafelo a a sireletsegileng le a a sa sireletsegang mo lefelong le le nnang mo go lone le mo inthaneteng. Bua kafa a ka bolokang tshedimosetso ya gagwe, ditshwantsho le dibidio e le khupamarama mo inthaneteng ka gone. Bua kafa selo se o se tsenyang gangwe mo inthaneteng, se nnang moo go ya go ile ka teng. Ba ka tswa ba itse sekai se se tswang kwa ditsaleng tsa bone.",
  RULES: "MELAO",
  ...
  "Sorry that things are difficult now. It is completely normal to struggle sometimes. Remember that you are not alone!":
    "Tshwarelo gore dilo di boima jaanong. Go tlwaelegile gore go nne thata ka dinako dingwe. Gopola gore ga o nosi!",
  ...
  "Greetings, everyone. \n\nToday's topic is self-care. \n\nThere are times where we experience challenging times, where we face problems and do not know what to do. It is important to take care of ourselves to learn the techniques of how we can keep ourselves calm in case problems, challenges or issues come up. \n\nWhen we are calm we are in a good state to think positively and come up with positive solutions to any challenges we may be facing.":
    "Dumelang, lotlhe. \n\nSetlhogo sa gompieno se bua ka go itlhokomela. \n\nGo na le dinako tse re itemogelang dikgwetlho, tse re lebanang le mathata e bile re sa itse gore re direng. Go botlhokwa gore re itlhokomele le go itse ditsela tsa kafa re ka ritibalang ka gone fa re lebane le mathata, dikgwetlho kgotsa fa go tsoga mathata. \n\nFa re ritibetse re mo boemong jo bo siameng jwa go akanya sentle le go tla ka ditharabololo tse di tshwanetseng mo dikgwetlhong dipe tse re lebaneng le tsone.",
  ...
  "* Relax activity\n* Recognise activity\n* Reward activity\n* Tools: How to add self-care\n* Customise the app\n* Home practice suggestions":
    "* Tiro ya go iketla\n* Tiro ya go lemoga\n* Tiro ya go ituela\n* Dithulusu: Tsela ya go tsenya lenaane la go itlhokomela\n* Dira gore tiriso e go tshwanele\n * Dikakantsho tsa katiso ya legae",
  ...
  "Call a friend or relative": "Leletsa tsala kgotsa losika",
  ...
  "Do a 30 second quick relaxation activity.":
    "Dira tiro ya ka pele ya metsotswana e le 30 ya go iketla.",
  RECOGNISE: "LEMOGA",
  'Take a moment and think of one thing YOU have done recently that you have done well! Say it aloud if you can "Well done for …"':
    "Tsaya nako o bo o akanya ka selo se le sengwe se O se dirileng moragong jaana se o se dirileng bontle thata! Buela kwa godimo fa o kgona “Ke ikakgolela ...”",
  REWARD: "TUELO",
  ...
  "Think of possible solutions and what would happen if we used them.":
    "Akanya ka ditharabololo tse di kgonegang le gore go ne go ka diregang fa re ne re di dirisitse.",
  "TRY IT": "E LEKE",
  ...
  "Did it work? Great! If it did not work, then try another solution.":
    "A e berekile? Go gontle! Fa e sa bereka, jaanong o ka leka tharabololo e nngwe.",
  ...
  '@global.w_solve_female_caregiver_2: "Anything for you, my dear. I will do it first thing after dinner. And you know? If that doesn’t work, we can always try something else together."\n\n@global.w_solve_teen_boy_2: "Thanks, @global.w_solve_female_caregiver_2"':
    '@global.w_solve_female_caregiver_2: “Ke direla wena, moratiwa. Ke tla e dira fela fa ke fetsa go ja dijo tsa maitseboa. A o a itse? Fa e le gore seo ga se dire, re ka leka se sengwe mmogo.”\n\n@global.w_solve_teen_boy_2: "Ke a leboga, @global.w_solve_female_caregiver_2"',
  ...
  "That didn’t work... Let's try something else.":
    "Seo ga se a bereka... A re leke sengwe se sele.",
  "Return the phone and save up": "Busa founo o bo o boloka madi",
  ...
  "Practice together on a problem you have now. One of you is the parent and one the teen. \n\nPraise and encourage each other – we are proud of you! \n\nRemember the steps: \nKNOW IT - SOLVE IT - TRY IT - TEST IT":
    "Ikatiseng mmogo ka mathata a le nang le one gone jaana. Mongwe wa lona ke motsadi o mongwe ke mosha. \n\nAkgolanang lo bo lo kgothatsana - re motlotlo ka lona! \n\nGakologelwa dikgato: \nA ITSE - A RARABOLOLE - E LEKE - E TLHATLHOBE",
  ...
  "We know how stressful it is to bring up teenagers in these times. Learning to manage your stress helps you - and your family.":
    "Re a itse gore go boima jang go godisa mosha mo dinakong tseno. Go ithuta go laola go tshwenyega mo maikutlong ga gago go thusa wena - le lelapa la gago.",
  "Greetings everyone. \n\nToday's topic is managing stress. \n\nIt is important to know how to manage our stress. At times our children can behave in ways that makes us feel stressed and us as parents can make our children feel stressed too. \n\nSo, it is important to notice when we feel stressed and take a pause and breathe. That will help you manage your stress.":
    "Dumelang lotlhe. \n\nSetlhogo sa gompieno se kaga go laola go tshwenyega mo maikutlong. \n\nGo botlhokwa go itse kafa re ka laolang go tshwenyega mo maikutlong a rona ka gone. Ka dinako tse dingwe bana ba rona ba ka itshwara ka tsela e e re opisang tlhogo le rona jaaka batsadi re ka dira gore bana ba rona ba opiwe ke tlhogo le bone. \n\nKa jalo, go botlhokwa go ela tlhoko fa re na le kgatelelo ya maikutlo re bo re ema go se kae re hema. Seo se tla go thusa gore o laole go tshwenyega mo maikutlong.",
  "Today you will explore:": "Gompieno o tlile go itse:",
  "* Story & discussion – that didn’t work…\n* Story & discussion – that worked!\n* Safety Amnesty story & discussion – that worked!\n* Tools: How to manage stress\nBREATHE - SHARE - SHOW\n* Home practice suggestions":
    "* Kgang le motlotlo - tse di sa berekang...\n* Kgang le motlotlo - tse di berekileng!\n* Kgololesego ya Pabalesego kgang le motlotlo - tse di berekileng!\n* Dithulusu: Kafa o ka laolang go tshwenyega mo maikutlong\nKGWA MOWA - BUANG - BONTSHA\n * Dikakantsho tsa katiso ya legae",
  ...
  "Let’s look at an example of how stress can sometimes just get too much, for all of us:":
    "A re bone sekai sa kafa go tshwenyega mo maikutlong e ka fetelelang ka teng ka dinako dingwe, mo go rona rotlhe:",
  ...
  "What could @global.w_stress_male_caregiver have done differently?":
    "@global.w_stress_male_caregiver A ka bo a ile a dira dilo jang ka tsela e e farologaneng?",
  "Recognise why he feels stressed": "Gakologelwa lebaka la go bo a tshwenyegile mo maikutlong",
  "Take a deep breath and speak calmly": "Kgwa mowa o bo o bua o ritibetse",
  "Show he understands his teen’s feelings":
    "O bontsha gore o tlhaloganya maikutlo a mosha wa gago",
  ...
  "* Recognise why he feels stressed \n* Take a deep breath and speak calmly  \n* Show he understands his teen’s feelings \n* Think about solutions together with @global.w_stress_teen_boy_1\n* Do something positive together with @global.w_stress_teen_boy_1":
    "* Gakologelwa lebaka la go bo a tshwenyegile mo maikutlong \n<b>* </b>Kgwa mowa o bo o bua o ritibetse  \n* O bontsha gore o tlhaloganya maikutlo a mosha wa gago \n* Akanya ka ditharabololo mmogo le @global.w_stress_teen_boy_1\n* Dira sengwe se se kgothatsang mmogo le @global.w_stress_teen_boy_1",
  ...
  "SHOW them you care": "Ba BONTSHE gore o amegile ka bone",
  ...
  "SEEK the positive": "BATLANG ka dilo tse dintle tse lo ka kgonang go di dira",
  "Can you and your teen think about ideas that might help? Can you do something positive together to take your mind off the stress?":
    "A gongwe wena le mosha wa gago lo ka akanya ka dikakantsho dingwe tse di ka thusang? A lo ka dira sengwe se se itumedisang se se ka dirang gore maikutlo a lona a seka a tswelela a tshwenyegile?",
  ...
  "Whenever you are feeling stressed or upset: take five breaths in and out before you react. \n\nAnd when you're both calm, share with your teen how you feel.":
    "Fa o ikutlwa o tshwenyegile mo maikutlong kgotsa o hutsafetse, kgwa mowa gatlhano pele ga o ka tsaya kgato. \n\nMme fa lotlhe lo ritibetse maikutlo, bolelela mosha wa gago gore o ikutlwa jang.",
  ...
  "Eat breakfast/lunch/dinner": "Ja dijo tsa mosong/tsa motshegare/tsa maitseboa",
  "Have tea after school": "Nwa tee morago ga sekolo",
  "Watch a T.V. show": "Lebelela lenaneo la T.V.",
  "Review homework": "Tlhatlhoba tiro ya mo gae ya sekolo",
  ...
  "Watching teen’s T.V. show together": "Go leba mmogo lenaane la basha mo T.V.",
  ...
  "Praise your teen for sharing": "Baka mosha wa gago ka gonne a ile a abela ba bangwe",
  ...
  Praise: "Baka",
  "How to praise": "Tsela ya go baka",
  ...
  Superpowers: "Maatla a Masaitsiweng",
  ...
  "**Praise yourself** @global.parent_point": "**Ipake** @global.parent_point",
  "One-on-one time": "Go ipha nako mmogo",
  "**One-on-one time** @global.parent_point": "**Go ipha nako mmogo** @global.parent_point",
  "Praise your teen": "Baka mosha wa gago",
  "**Praise your teen** @global.parent_point": "**Baka mosha wa gago** @global.parent_point",
  ...
  "Sometimes it will be easy and fun to spend time with your teens, and sometimes it will be more challenging. Spending time together will greatly improve your relationship; well done for trying!":
    "Ka dinako dingwe go tla nna motlhofo go fetsa nako le mosha wa gago mme ka dinako dingwe e tlile go nna kgwetlho e kgolo. Go fetsa nako mmogo go tla tokafatsa tsela e lo dirisanang ka yone; o dirile sentle tota ka go lekeletsa go dira seno!",
  ...
  "Talking about how we feel can be difficult at first, but you and your teen will get used to it. Keep trying, and you will see the positive results!":
    "Go ka nna ga nna thata lekgetlo la ntlha go tlhalosa gore re ikutlwa jang mme gone, wena le mosha wa gago lo tla tlwaela. Nna o leke mme fa go ntse go ile, dilo di tla tsamaya sentle!",
