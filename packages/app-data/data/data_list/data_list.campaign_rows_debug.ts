    ...
    rows: [
      ...
      },
      {
          ...
          action_list: {
            "0": {
              args: {
                "0": [
                  {
                    fullExpression: "@data.something_fun.co_chef.text_template",
                    matchedExpression: "@data.something_fun.co_chef.text_template",
                    type: "data",
              ...
              _raw: [
                {
                  fullExpression: "go_to: @data.something_fun.co_chef.text_template",
                  matchedExpression: "@data.something_fun.co_chef.text_template",
                  type: "data",
                  fieldName: "something_fun",
                },
              ...
              _cleaned: [
                {
                  fullExpression: "click | go_to: @data.something_fun.co_chef.text_template",
                  matchedExpression: "@data.something_fun.co_chef.text_template",
                  type: "data",
                  fieldName: "something_fun",
                },
        ...
        _dynamicDependencies: {
          "@data.something_fun.co_chef.text_template": [
  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
              ...
              condition_args: {
                db_lookup: {
                  evaluate: {
                    value: [
                      {
                        fullExpression: "@calc(Math.min(0.001,0.002))",
                        matchedExpression: "@calc(Math.min(0.001,0.002))",
                        type: "calc",
                        fieldName: "Math.min(0.001,0.002)",
                      },
                    ],
                  },
                },
        ...
        _dynamicDependencies: {
          "@calc(Math.min(0.001,0.002))": [
            "activation_condition_list.0.condition_args.db_lookup.evaluate.value",
          ],
        },
      },
      {
              ...
              condition_args: {
                db_lookup: {
                  evaluate: {
                    value: [
                      {
                        fullExpression: "@calc(Math.min(1,3))",
                        matchedExpression: "@calc(Math.min(1,3))",
                        type: "calc",
                        fieldName: "Math.min(1,3)",
                      },
                    ],
                  },
                },
              ...
              condition_args: {
                db_lookup: {
                  evaluate: {
                    value: [
                      {
                        fullExpression: "@calc(Math.max(1,3))",
                        matchedExpression: "@calc(Math.max(1,3))",
                        type: "calc",
                        fieldName: "Math.max(1,3)",
                      },
                    ],
                  },
                },
