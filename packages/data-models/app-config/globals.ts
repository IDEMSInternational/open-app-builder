/**
 * WiP - placeholder to organise hardcoded strings used in the app
 * Will eventually integrate with globals/translation system
 *
 * Some specific strings are currently hardcoded into the app
 * TODO - not all strings included, should add to when required
 * TODO - needs to be included in translations systems
 */
export default {
